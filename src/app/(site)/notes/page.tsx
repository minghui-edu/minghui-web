...
export const metadata: Metadata = {
  title: '學霸筆記商城',
  description: '明慧教育嚴選最強頂大學霸高分筆記，完整觀念分析、題型分類，涵蓋數學、國文、英文等科目，高效提升學習成效與考試分數。',
  openGraph: {
    title: '最強學霸筆記商城 | 明慧教育',
    description: '嚴選頂大學霸高分筆記，完整觀念分析、題型分類，高效提升學習成效。',
...
const videos = [
  { id: 'zogyPJGz9fE', title: '【最強】一天速成!! 英文作文原來可以如此簡單' },
...
export default async function NotesPage() {
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden py-28" style={{ background: 'var(--navy)' }}>
        <div className="hidden md:block absolute inset-0">
          <div className="absolute inset-y-0 right-0 w-[58%] overflow-hidden">
            <Image src="/hero-notes.png" alt="" fill className="object-cover object-center" priority sizes="58vw" />
          </div>
        ...
        <div className={`relative ${inner}`}>
          ...
          <p className="text-lg leading-relaxed max-w-2xl" style={{ color: 'rgba(255,255,255,0.62)' }}>
            嚴選頂尖學長姐親手整理的專屬精華各科筆記，作文速成模板、完整觀念分析與題型分類，讓你用最少時間掌握最多重點得高分。
          </p>
        </div>
      </section>
      ...
      {/* ── FAQ ───────────────────────────────── */}
      <FaqSection items={[
        { q: '高分筆記適合哪些學生？', a: '適合想節省整理時間、提升複習效率、考前快速抓重點，或希望建立完整知識架構的學生。無論是應付學校期中期末考，還是準備學測、分科，都能找到對應的筆記資源。' },
        { q: '高分筆記適合考前衝刺嗎？', a: '很適合。考前時間有限時，高分筆記可以幫助學生快速抓住重要概念與核心考點，避免在龐雜的課本中迷失方向，提升複習效率。' },
        { q: '高分筆記和一般網路筆記有什麼不同？', a: '相較於零散的網路資料，高分筆記更重視考試上能直接使用並得分的內容——重點整理清楚、邏輯架構完整，是真正在考試中拿到高分的學長姐親身整理的精華。' },
        { q: '筆記是電子版還是紙本？', a: '目前為電子版 PDF 格式，購買後可立即下載，方便在電腦、平板、手機等各裝置上使用，也可自行列印成紙本。' },
        { q: '購買後可以退款嗎？', a: '由於筆記為數位商品，出貨後恕不接受退款申請。建議購買前仔細閱讀筆記介紹、預覽頁面，若有任何疑問也歡迎先加入 LINE 詢問。' },
      ]} />
