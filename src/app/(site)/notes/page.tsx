...
export default async function NotesPage() {
  ...
  return (
    <div>
      ...
      {/* ── FAQ ───────────────────────────────── */}
      <FaqSection items={[
        { q: '高分筆記適合哪些學生？', a: '適合想節省整理時間、提升複習效率、考前快速抓重點，或希望建立完整知識架構的學生。無論是應付學校期中期末考，還是準備學測、指考，都能找到對應的筆記資源。' },
        ...
        { q: '筆記的作者是誰？品質如何保證？', a: '所有筆記均由台大、清大、交大、成大等頂尖名校的在校生或畢業生撰寫，學業成績優異。我們在上架前會嚴格審查筆記內容的正確性、完整性與可讀性。' },
