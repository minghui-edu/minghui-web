...
const modes = [
  {
    ...
    title: '多元科系探索營',
    badge: '適合多方探索',
    desc: '不限單一科系，透過跨領域的營隊活動，讓想多方探索個人興趣的學生，透過學長姐分享，深入了解各科系學習內容、畢業出路。',
    points: [
  ...
  },
  {
    ...
    title: '單一科系深度講座 & 實作',
    badge: '適合深入探索',
    desc: '專為多方探索後，已有心儀科系的學生。由該科系畢業、從業中的學長姐帶領，深入解析該科系學習內容，並親手完成相關專題實作，豐富學習歷程。',
    points: [
...
const highlights = [
  ...
  { icon: FlaskConical, title: '科系專題實作',     desc: '在專業人員帶領下完成實作成品，提前感受關於心儀科系的核心學習內容。',           color: '#7B4F12'      },
...
const explorationTestimonials: Testimonial[] = [
  ...
  {
    quote: '這次講座讓我第一次了解到物治系究竟在學什麼、需要掌握哪些核心知識，講師還分享了畢業後的薪資，這是學校老師都不會講的，很開心可以了解到這麼多。專題實作老師也一一點評了大家的實作成果、並給出很多實用的建議，讓我更堅定想考物治系了！',
    name: '張同學',
    context: '物治系講座學員',
    year: '2025',
  },
  {
    quote: '便當超好吃！然後黑客松活動居然讓我在短短兩天內，跟完全不認識的同學合作完成了一個網頁工具，超誇張！這個經驗讓我確定自己想念資工系，也讓我第一次有了真正有說服力的作品。',
    name: '李同學',
    context: '第九屆科系探索領袖營學員',
    year: '2026',
  },
  {
    quote: '講座內容超充實，老師分享了大學真正在學的課程、筆記簡報，也了解到臨床心理師、諮商心理師原來是不一樣的，原來心理系畢業後還需要考研究所，讓我更清楚未來方向！實作內容也很有趣，希望未來能如願考上心理系',
    name: '謝同學',
    context: '心理系講座學員',
    year: '2025',
  },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-base leading-relaxed mb-6" style={{ color: 'var(--muted)' }}>
                DELC 是明慧教育自主研發的旗艦營隊品牌，結合專業講師分享、真人圖書館、科技黑客松實作、校園實境解謎與跨領域挑戰，打破傳統「聽講式」體驗營的框架。
              </p>
